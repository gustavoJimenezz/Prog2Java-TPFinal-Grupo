...
public class ArticuloPorDemanda extends Articulo {
	...
	public ArticuloPorDemanda(int id, String nombreArticulo, double precioArticulo, int stockArticulo, char rubroArticulo, int stockDesdeado) {
...
//		maximo 50 porciento
	...
	public void setStockDeseado(int stockDeaseado) {
		this.stockDeseado = stockDeaseado;
	}
}
